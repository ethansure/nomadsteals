  ...
  if (status === "success") {
    return (
      <div className={`text-center p-6 bg-green-50 rounded-2xl border border-green-200 ${className}`}>
        ...
        <h3 className="font-bold text-green-800 text-lg mb-1">{t('subscribed')}</h3>
        <p className="text-green-700 text-sm">{t('subscribedSubtitle')}</p>
      </div>
    );
  }
    ...
    return (
      <div className={`bg-white rounded-2xl shadow-lg p-8 border border-gray-100 ${className}`}>
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">{t('dailyAlerts')}</h3>
